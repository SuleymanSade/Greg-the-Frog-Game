...
class GregGame:
    def __init__(self, root):
        ...
        self.game_over_label = tk.Label(self.game_over_frame, text= "Game over, you have been hit by an astroid", font= ("Arial", 24), bg="black", fg="white")
        self.final_score_label1 = tk.Label(self.game_over_frame, font=("Arial", 24), bg="black", fg="white")
        self.final_score_label2 = tk.Label(self.game_over_frame, font=("Arial", 45), bg="black", fg="white")
        self.restart_button = tk.Button(self.game_over_frame, text="Restart the Game", command=self.start_game, width=20, height=2, font=("Arial", 24), bg="black", fg="white")
